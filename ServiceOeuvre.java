...
public class ServiceOeuvre {
    ...
    public boolean addOeuvre (TextField nomOUV,TextField Prixoeuvre,TextField nomcat,TextField Emailartiste)
    { 

       String url = statics.BASE_URL+"/addOeuvre?nomoeuvre="+nomOUV.getText()+"&prixoeuvre="+Prixoeuvre.getText()+"&nomcat="+nomcat.getText()+"&emailartiste="+Emailartiste.getText();
       req.setUrl(url);
