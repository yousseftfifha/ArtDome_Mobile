...
public class ServiceEvent {
    ...
    public boolean addEvent(Event ev) {
        String url = Statics.BASE_URL + "/addEvent/" + ev.getNomEvent()+ "/" + ev.getThemeEvent(); //création de l'URL
        ...
        try {
            ...
            */
            ...
            for(Map<String,Object> obj : list){
                ...
                Event ev = new Event();
                float id = Float.parseFloat(obj.get("codeEvent").toString());
                ev.setCodeEvent((int)id);
                ev.setNomEvent(obj.get("nomEvent").toString());
                ev.setThemeEvent(obj.get("themeEvent").toString());
                ev.setEtat(obj.get("etat").toString());
              ...
              float nbp = Float.parseFloat(obj.get("nbMaxPart").toString());
                ...
                ev.setVideo(obj.get("video").toString());
                events.add(ev);
            }
    ...
    public ArrayList<Event> getAllEvents(){
        String url = Statics.BASE_URL+"/listEvent";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
        ...
        con.setUrl(Statics.BASE_URL+"/deleteEvent/"+id);
        con.setPost(false);
