 ...
 * @author bhk
 */
public class ListUserForm extends HomeForm{

    public ListUserForm(Form previous,Resources res)  throws IOException {
       super("Users", BoxLayout.y());
        ...
        for ( User ev : list) {
           ...
           //Image img1 = Image.createImage(imageFile+ev.getImage());
                ...
                SpanLabel spl = new SpanLabel("ID: " + "  " + ev.getID());
                SpanLabel spl2 = new SpanLabel("Nom: " + "  " + ev.getNom());
                SpanLabel spl3 = new SpanLabel("Prenom: " + "  " + ev.getPrenom());
                SpanLabel spl7 = new SpanLabel("sexe: " + "  " + ev.getSexe());
                SpanLabel spl4 = new SpanLabel("Numero: " + "  " + ev.getNumero());
                SpanLabel spl5 = new SpanLabel("ville: " + "  " + ev.getVille());
                SpanLabel spl6 = new SpanLabel("email: " + "  " + ev.getEmail());
             ...
             //c2.addAll(spl2,spl3,spl4,spl5);
                sup.addActionListener((evt) -> {
                   ServiceUser.getInstance().Supprimer(ev.getID());
