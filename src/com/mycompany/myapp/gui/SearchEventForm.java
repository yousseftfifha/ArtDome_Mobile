 ...
 * @author HP
 */
public class SearchEventForm extends HomeForm{

    public SearchEventForm(Form previous,Resources res, String name)  throws IOException {
        ...
        list = ServiceEvent.getInstance().searchEvent(name);
        for ( Event ev : list) {
