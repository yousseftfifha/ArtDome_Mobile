 ...
 * @author HP
 */
public class SearchExpoForm extends HomeForm{

    public SearchExpoForm(Form previous,Resources res, String name)  throws IOException {
       ...
       ArrayList<Exposition> list;
        ...
        addAll(i,spl,spl2,spl5,sup,partager);
